...
channelQuery() {
  ...
  then
    ...
    peerChannelList "cli.org2.example.com" "peer1.org2.example.com:7062"
  ...
  then
    ...
    peerChannelList "cli.org3.example.com" "peer1.org3.example.com:7082"
  ...
  then
    ...
    peerChannelFetchConfig "my-channel1" "cli.org2.example.com" "$TARGET_FILE" "peer0.org2.example.com:7061"
    ...
    [ "$1" = "getinfo" ] && [ "$2" = "my-channel1" ] && [ "$3" = "org2" ] && [ "$4" = "peer1" ]
  then

    peerChannelGetInfo "my-channel1" "cli.org2.example.com" "peer1.org2.example.com:7062"

  elif [ "$1" = "fetch" ] && [ "$2" = "config" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org2" ] && [ "$5" = "peer1" ]; then
    TARGET_FILE=${6:-"$channel-config.json"}

    peerChannelFetchConfig "my-channel1" "cli.org2.example.com" "$TARGET_FILE" "peer1.org2.example.com:7062"

  elif [ "$1" = "fetch" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org2" ] && [ "$5" = "peer1" ]; then
    BLOCK_NAME=$2
    TARGET_FILE=${6:-"$BLOCK_NAME.block"}

    peerChannelFetchBlock "my-channel1" "cli.org2.example.com" "${BLOCK_NAME}" "peer1.org2.example.com:7062" "$TARGET_FILE"

  elif
    [ "$1" = "getinfo" ] && [ "$2" = "my-channel1" ] && [ "$3" = "org3" ] && [ "$4" = "peer0" ]
  then

    peerChannelGetInfo "my-channel1" "cli.org3.example.com" "peer0.org3.example.com:7081"

  elif [ "$1" = "fetch" ] && [ "$2" = "config" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org3" ] && [ "$5" = "peer0" ]; then
    TARGET_FILE=${6:-"$channel-config.json"}

    peerChannelFetchConfig "my-channel1" "cli.org3.example.com" "$TARGET_FILE" "peer0.org3.example.com:7081"

  elif [ "$1" = "fetch" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org3" ] && [ "$5" = "peer0" ]; then
    BLOCK_NAME=$2
    TARGET_FILE=${6:-"$BLOCK_NAME.block"}

    peerChannelFetchBlock "my-channel1" "cli.org3.example.com" "${BLOCK_NAME}" "peer0.org3.example.com:7081" "$TARGET_FILE"

  elif
    [ "$1" = "getinfo" ] && [ "$2" = "my-channel1" ] && [ "$3" = "org3" ] && [ "$4" = "peer1" ]
  then

    peerChannelGetInfo "my-channel1" "cli.org3.example.com" "peer1.org3.example.com:7082"

  elif [ "$1" = "fetch" ] && [ "$2" = "config" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org3" ] && [ "$5" = "peer1" ]; then
    TARGET_FILE=${6:-"$channel-config.json"}

    peerChannelFetchConfig "my-channel1" "cli.org3.example.com" "$TARGET_FILE" "peer1.org3.example.com:7082"

  elif [ "$1" = "fetch" ] && [ "$3" = "my-channel1" ] && [ "$4" = "org3" ] && [ "$5" = "peer1" ]; then
    BLOCK_NAME=$2
    TARGET_FILE=${6:-"$BLOCK_NAME.block"}

    peerChannelFetchBlock "my-channel1" "cli.org3.example.com" "${BLOCK_NAME}" "peer1.org3.example.com:7082" "$TARGET_FILE"
...
printChannelsHelp() {
  ...
  echo "fablo channel getinfo my-channel1 org2 peer1"
  echo -e "\t Get channel info on 'peer1' of 'Org2'".
  echo ""
  echo "fablo channel fetch config my-channel1 org2 peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'Org2'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> my-channel1 org2 peer1 [file name]"
  ...
  echo "fablo channel getinfo my-channel1 org3 peer1"
  echo -e "\t Get channel info on 'peer1' of 'Org3'".
  echo ""
  echo "fablo channel fetch config my-channel1 org3 peer1 [file-name.json]"
  echo -e "\t Download latest config block and save it. Uses first peer 'peer1' of 'Org3'".
  echo ""
  echo "fablo channel fetch <newest|oldest|block-number> my-channel1 org3 peer1 [file name]"
  echo -e "\t Fetch a block with given number and save it. Uses first peer 'peer1' of 'Org3'".
  echo ""
